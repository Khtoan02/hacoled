...
?>
<div
    class="woocommerce-no-products-found bg-white rounded-2xl border border-slate-100 shadow-sm p-10 md:p-14 text-center my-4">
    <div class="max-w-md mx-auto">
        ...
        <p class="text-xs text-slate-500 leading-relaxed mb-6">
            Danh mục sản phẩm này hiện tại chưa có sản phẩm hiển thị. Chúng tôi đang cập nhật các thiết bị công nghệ mới
            nhất. Quý khách vui lòng tham khảo các danh mục khác hoặc liên hệ hotline để được tư vấn nhanh nhất.
        </p>
        <div class="flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <a href="tel:0342324488"
                ...
                <span>Hotline 034.232.44.88</span>
            </a>
        </div>
    </div>
</div>