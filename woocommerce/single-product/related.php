<?php
/**
 * Related Products Template Override for HacoLED Theme
 *
...
if ( $related_products ) : ?>
	...
	<section class="related products mt-16 pt-10 border-t border-gray-200/80 relative">
		...
		<div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8 lg:mb-10">
			<div>
				<div class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-red-50 border border-red-200/80 text-[#D90429] text-[11px] font-extrabold uppercase tracking-widest mb-2.5 shadow-xs">
					<i class="ph-bold ph-squares-four text-xs"></i> Gợi Ý Dự Án
				</div>
				<h2 class="text-2xl lg:text-3xl font-extrabold text-gray-900 tracking-tight">Sản Phẩm Cùng Phân Khúc</h2>
				<p class="text-xs lg:text-sm text-gray-500 font-medium mt-1">Các giải pháp màn hình LED chất lượng cao được nhiều công trình lựa chọn</p>
			</div>
