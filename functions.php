<?php
/**
 * Haco LED Theme functions and definitions
 */

// 1. REQUIRE AND REGISTER MVC AUTOLOADER
require_once get_template_directory() . '/app/Core/Autoloader.php';
...
function hacoled_scripts() {
    ...
    wp_enqueue_style('hacoled-core-style', get_stylesheet_uri(), [], '1.0.0');
