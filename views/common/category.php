      ...
      <div class="relative z-10 max-w-4xl space-y-4">
        ...
        <div class="flex flex-wrap items-center gap-3">
          <div class="w-9 h-9 md:w-10 md:h-10 rounded-xl flex items-center justify-center text-[#3a1f05] shadow-lg shrink-0"
            ...
            <i class="ph-bold ph-newspaper text-lg text-[#851800]"></i>
          </div>
          <div class="flex items-center gap-2 border border-[#FFD700]/30 bg-[#000000]/25 rounded-lg px-3 py-1 shadow-sm">
            ...
            <span class="text-[11px] font-black text-[#FFE8A3] uppercase tracking-widest"><?php _e('Chuyên mục bài viết', 'hacoled'); ?></span>
          </div>
        ...
        <?php if (!empty($description)): ?>
          <p class="text-[#FFF3D1] text-xs md:text-sm lg:text-base leading-relaxed font-medium max-w-3xl pt-1 drop-shadow-sm"><?php echo esc_html($description); ?></p>
        <?php else: ?>
          <p class="text-[#FFF3D1]/90 text-xs md:text-sm lg:text-base leading-relaxed font-medium max-w-3xl pt-1 drop-shadow-sm"><?php echo sprintf(__('Tổng hợp các tin tức, bài viết chia sẻ kinh nghiệm lắp đặt và các giải pháp trình chiếu màn hình hiển thị & âm thanh sự kiện tối tân nhất liên quan đến %s.', 'hacoled'), esc_html($category_name)); ?></p>
        <?php endif; ?>
      </div>
    </div>
