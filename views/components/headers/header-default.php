...
<header
  ...
  <div class="w-full relative">
    ...
    <div class="w-full relative z-10 py-1.5 border-b border-white/10"
         x-show="!scrolled" x-transition:leave="transition ease-in duration-200" x-transition:leave-start="opacity-100 max-h-10" x-transition:leave-end="opacity-0 max-h-0">
      <div class="max-w-[1440px] mx-auto px-4 lg:px-8 flex items-center justify-between gap-4 text-[11px] text-white/90 font-medium">
        ...
        <div class="flex-1 overflow-hidden relative flex items-center gap-3">
          <span class="bg-white/15 text-white px-2 py-0.5 rounded text-[8px] font-extrabold uppercase tracking-wider shrink-0 animate-pulse border border-white/20">Tin Mới</span>
        ...
        <a href="tel:0342324488" class="shrink-0 text-[#fbbf24] hover:text-white flex items-center gap-1.5 font-bold text-[10px] uppercase tracking-wider">
