...
/**
 * Controller for HacoLED custom page templates.
 *
 * Generic WordPress pages are handled by PageController. This controller owns
 * only the explicitly selected marketing, blog, project and career templates.
 */
class TemplateController extends Controller {
    ...
    public function blog() {
        ...
        // Mock data for each section — fills in any section that has no real posts
        $mock_sections = [
                'press' => [
                    [
                        'id' => 301,
                ...
                'projects' => [
                    [
                        ...
                        'excerpt' => __('Thi công lắp đặt màn hình LED P3 trong nhà độ sắc nét cao phục vụ hội thảo và trình chiếu nội dung truyền thông.', 'hacoled'),
                        'permalink' => '#', 'date' => '15/06/2026', 'author' => 'Đội kỹ thuật', 'category' => __('Dự án', 'hacoled'),
                        'thumbnail' => 'https://images.unsplash.com/photo-1517604931442-7e0c8ed2963c?q=80&w=800&auto=format&fit=crop',
                        'reading_time' => '4 phút đọc'
                    ],
                    [
                        'id' => 3202,
                        'title' => __('Lắp đặt màn hình LED P1.5 tại CT Cổ Phần Đầu Tư FORTUNE', 'hacoled'),
                        'excerpt' => __('Giải pháp hiển thị cực nét với pixel pitch siêu nhỏ P1.5, phục vụ họp trực tuyến và trưng bày sản phẩm.', 'hacoled'),
                        'permalink' => '#', 'date' => '10/06/2026', 'author' => 'Đội kỹ thuật', 'category' => __('Dự án', 'hacoled'),
                        'thumbnail' => 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?q=80&w=800&auto=format&fit=crop',
                        'reading_time' => '5 phút đọc'
                    ],
                    [
                        'id' => 3203,
                        'title' => __('Lắp đặt màn hình LED P3.91 ngoài trời tại Trường THPT FPT Tây Hà Nội', 'hacoled'),
                        'excerpt' => __('Màn hình LED ngoài trời chịu nước bụi IP65, độ sáng >5500 nits, phục vụ hoạt động chào cờ và thể thao.', 'hacoled'),
                        'permalink' => '#', 'date' => '05/06/2026', 'author' => 'Đội kỹ thuật', 'category' => __('Dự án', 'hacoled'),
                        'thumbnail' => 'https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?q=80&w=800&auto=format&fit=crop',
                        'reading_time' => '5 phút đọc'
                    ],
                    [
                        'id' => 3204,
                        'title' => __('Hệ thống âm thanh hội trường tại Trung tâm Hội nghị Quốc gia', 'hacoled'),
                        'excerpt' => __('Đường bộ toàn diện hệ thống âm thanh loa Array phối hợp với đèn Moving Head, đèn Par LED cao cấp.', 'hacoled'),
                        'permalink' => '#', 'date' => '01/06/2026', 'author' => 'Đội kỹ thuật', 'category' => __('Dự án', 'hacoled'),
                        'thumbnail' => 'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?q=80&w=800&auto=format&fit=crop',
                        'reading_time' => '6 phút đọc'
                    ]
                ]
