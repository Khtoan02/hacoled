...
return [
    'home' => [
        'label' => 'Trang Chủ', 'enabled' => true, 'kind' => 'link', 'url' => home_url('/'),
    ],
    'about' => [
        'label' => 'Về HacoLED', 'enabled' => true, 'kind' => 'dropdown',
        'items' => [
    ...
    'led' => [
        'label' => 'Màn Hình LED', 'enabled' => true, 'kind' => 'mega',
        'columns' => [
            ['title' => 'LED Trong Nhà', 'icon' => 'monitor', 'tone' => 'red', 'item_columns' => 1, 'items' => [
            ...
            ['title' => 'LED Ngoài Trời', 'icon' => 'sun', 'tone' => 'gold', 'item_columns' => 1, 'items' => [
    ...
    'videowall' => [
        'label' => 'Màn Hình Ghép', 'enabled' => true, 'kind' => 'mega',
        'columns' => [[
            'title' => 'Màn Hình Ghép Videowall', 'icon' => 'grid', 'tone' => 'red', 'item_columns' => 1,
            'items' => [
    ...
    'solutions' => [
        'label' => 'Giải Pháp', 'enabled' => true, 'kind' => 'mega',
        'columns' => [[
            'title' => 'Giải Pháp Màn Hình LED', 'icon' => 'sparkles', 'tone' => 'red', 'item_columns' => 2,
            'items' => [
    ...
    'audio' => [
        'label' => 'Âm Thanh', 'enabled' => true, 'kind' => 'mega',
        'columns' => [
            ['title' => 'DBAcoustic', 'icon' => 'speaker', 'tone' => 'red', 'item_columns' => 1, 'items' => [
            ...
            ['title' => 'TD Classic', 'icon' => 'speaker', 'tone' => 'slate', 'item_columns' => 1, 'items' => [
            ...
            ['title' => 'CF Audio & Peavey', 'icon' => 'speaker', 'tone' => 'gold', 'item_columns' => 1, 'items' => [
    ...
    'projects' => [
        'label' => 'Dự án đã thực hiện', 'enabled' => true, 'kind' => 'mega',
        'columns' => [[
            'title' => 'Hồ Sơ Năng Lực', 'icon' => 'document', 'tone' => 'red', 'item_columns' => 2,
            'items' => [
    ...
    'services' => [
        'label' => 'Dịch Vụ', 'enabled' => true, 'kind' => 'link', 'url' => hacoled_managed_page_url('services'),
    ],
    'news' => [
        'label' => 'Tin Tức & Blog', 'enabled' => true, 'kind' => 'dropdown',
        'items' => [
    ...
    'contact' => [
        'label' => 'Liên Hệ', 'enabled' => true, 'kind' => 'link', 'url' => hacoled_managed_page_url('contact'),
    ],
];
